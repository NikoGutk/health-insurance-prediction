...
st.title("Health Inscurance Payment Predictor")
...
with st.form("input-form"):
    ...
    with col2:
        bloodpressure = st.number_input("Average Blood Pressure", min_value=60, max_value=200, value=120)
...
if submitted:
    ...
    st.success(f"Estimated Insurance Payment is: {prediction:,.2f}$")
